...
#[Route(path: '/role/edit/{role}', name: Edit::ROUTE_NAME, siteAware: true)]
#[IsGranted(MembershipRole::ROLE_ADMIN->name)]
final class Edit extends AbstractController
{
    public const string ROUTE_NAME = 'role.edit';
    ...
    public function __invoke(Request $request, Site $site, Role $role): array|Response
    {
        $p = clone $role;
        ...
        return ['form' => $form->createView(), 'role' => $p];
    }
}
